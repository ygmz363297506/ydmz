...
function csetPageActiveAndPageNow(now, div) {
	try {
		...
		if ($(now).is($("#" + div + " .Pages ul li a").first())) {
			...
			isSubmit = true;
			topage = topage + 1;
		} else if ($(now).text() == "┉" && $(now).parent().next().is($("#" + div + " .Pages ul li").last())) {
			isSubmit = false;
			...
			$("#" + div + " .Pages ul li").not($("#" + div + " .Pages ul li").first()).not($("#" + div + " .Pages ul li").last()).slideUp();
			$("#" + div + " .Pages ul li").not($("#" + div + " .Pages ul li").first()).not($("#" + div + " .Pages ul li").last()).remove();
			$("#" + div + " .Pages ul li").first().after(nextpages);
		} else if ($(now).text() == "┉" && $(now).parent().prev().is($("#" + div + " .Pages ul li").first())) {
			isSubmit = false;
			...
			$("#" + div + " Pages ul li").not($("#" + div + " .Pages ul li").first()).not($("#" + div + " .Pages ul li").last()).slideUp();
			$("#" + div + " .Pages ul li").not($("#" + div + " .Pages ul li").first()).not($("#" + div + " .Pages ul li").last()).remove();
			$("#" + div + " .Pages ul li").first().after(prevpages);
...
function csetPageActive(div) {
	try {
		...
		if ($("#" + div + " #pageNow").val() == $("#" + div + " .Pages ul li").first().next().text()) {
